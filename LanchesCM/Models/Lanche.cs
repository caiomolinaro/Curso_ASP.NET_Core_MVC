...
namespace LanchesCM.Models
{
    ...
    public class Lanche
    {
        ...
        [StringLength (80, MinimumLength = 10, ErrorMessage = "P {0} deve ter no mínimo {1} e no máximo {2}")]
        ...
        public int CategoriaId { get; set; } //o ef core vai entender como uma foreign key e criar a relação
